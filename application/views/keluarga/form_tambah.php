      ...
      <div class="card-body">
        <form action="" method="post" class="row g-3">
          <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" name="no_kk" id="">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="nama_lgkp" id="">
          ...
          <div class="form-group form-group col-md-4">
            ...
            <input type="text" class="form-control" name="tmp_lhr" id="">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="keb_khs" id="">
          </div>
