                ...
                <select class="form-control" name="hbkel" id="">
                  ...
                  <?php foreach ($keluarga as $klg) : ?>
                    <?php if ($klg['hbkel'] == 'Kepala Keluarga') { ?>
                      <option value="<?= $klg['no_kk'] ?>"><?= $klg['no_kk'] ?> - <?= $klg['nama_lgkp'] ?></option>
                    <?php } ?>
                  <?php endforeach; ?>
                </select>
              </div>
              ...
              <div class="form-group mb-0">
                <div class="row">
                  ...
                  <div class="col-sm">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="sbr_air" id="inlineRadio1" value="Sungai">
                      <label class="form-check-label" for="inlineRadio1">Sungai</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="sbr_air" id="inlineRadio2" value="Lainnya">
